    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-[#0a0b10] px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-white/[0.02] border border-white/[0.07] backdrop-blur-xl p-8 rounded-2xl shadow-2xl relative z-10 transition-all duration-300 hover:border-white/[0.12]">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-xl bg-gradient-to-tr from-violet-600 to-indigo-600 text-white font-bold text-2xl shadow-lg mb-4">
            A
          </div>
          <h2 className="text-white text-3xl font-extrabold tracking-tight">Welcome Back</h2>
          <p className="text-gray-400 text-sm mt-2 font-medium">Admin Dashboard Access Portal</p>
        </div>
        ...
        <form className="space-y-6" onSubmit={handleLogin}>
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3.5 rounded-xl bg-white/[0.04] border border-white/[0.1] text-white placeholder-gray-500 outline-none focus:border-violet-500 focus:bg-white/[0.06] focus:ring-1 focus:ring-violet-500 transition-all duration-200 text-sm font-medium"
              required
            />
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 text-white font-bold py-4 rounded-xl shadow-lg shadow-violet-900/20 active:scale-[0.98] transition-all duration-150 cursor-pointer disabled:opacity-50 flex items-center justify-center text-sm uppercase tracking-wider"
          >
            {loading ? (
